...
/**
 * @class
 * @name EventSeveritiesListItem
 * @description Single event severity list item component.
 * Render single event severity details
 *
 * @version 0.1.0
 * @since 0.1.0
 */
class EventSeveritiesListItem extends Component {
   ...
   * @description show confirm modal before archiving an event severity
   *
   * @version 0.1.0
   * @since 0.1.0
   */
  ...
  render() {
    ...
    return (
      <div
        className="EventSeveritiesListItem"
...
EventSeveritiesListItem.propTypes = {
...
export default EventSeveritiesListItem;
