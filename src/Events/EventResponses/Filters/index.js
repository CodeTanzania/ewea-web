...
/**
 * @class
 * @name EventResponsesFilters
 * @description Filter modal component for filtering contacts
 * @version 0.1.0
 * @since 0.1.0
 */
class EventResponsesFilters extends Component {
  /**
   * @function
   * @name handleSubmit
...
EventResponsesFilters.propTypes = {
...
EventResponsesFilters.defaultProps = {
  filter: null,
  cached: null,
};

export default Connect(Form.create()(EventResponsesFilters), {
  filter: 'eventResponses.filter',
});
