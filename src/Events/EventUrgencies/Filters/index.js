 ...
 * @since 0.1.0
 */
class EventUrgenciesFilters extends Component {
  /**
   * @function
   * @name handleSubmit
...
EventUrgenciesFilters.propTypes = {
...
EventUrgenciesFilters.defaultProps = {
  filter: null,
  cached: null,
};

export default Connect(Form.create()(EventUrgenciesFilters), {
  filter: 'eventUrgencies.filter',
});
