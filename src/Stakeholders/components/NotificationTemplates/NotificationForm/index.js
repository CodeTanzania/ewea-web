 ...
 * @description Render Notification Template form component
 *
 * @version 0.1.0
 * @since 0.1.0
 */
        ...
        <Form.Item {...formItemLayout} label="Subject">
          {getFieldDecorator('subject', {
            rules: [
              {
                required: true,
                message: 'Notification template subject is required',
              },
            ],
            initialValue: subject,
          })(<Input placeholder="Notification template subject" />)}
        </Form.Item>
        {/* notification subject */}
